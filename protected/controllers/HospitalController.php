...
public function actionHelp()
	...
	public function actionWrite()
	{
	  ...
	  if(isset($_POST['Hospital']))
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Hospital']['fullname'],'mmsemptyfullname','emptystring'),
            )
        );
        if ($messages == '') {
	...
	public function actionWriteaddress()
	{
	  ...
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Hospitaladdress']['addresstypeid'],'mmpremptyaddresstypeid','emptystring'),
                array($_POST['Hospitaladdress']['addressname'],'mmpremptyaddressname','emptystring'),
                array($_POST['Hospitaladdress']['cityid'],'mmpremptycityid','emptystring'),
            )
        );
        if ($messages == '') {
	...
	public function actionWritecontact()
	{
	  ...
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Hospitalcontact']['contacttypeid'],'mmpremptycontacttypeid','emptystring'),
                array($_POST['Hospitalcontact']['addresscontactname'],'mmpremptyaddresscontactname','emptystring'),
            )
        );
        if ($messages == '') {
