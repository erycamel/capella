	...
	public function actionWrite()
	{
	  ...
	  if(isset($_POST['Requestedby']))
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Requestedby']['requestedbycode'],'irebyemptyrequestedbycode','emptystring'),
                array($_POST['Requestedby']['description'],'irebyemptydescription','emptystring'),
            )
        );
        if ($messages == '') {
