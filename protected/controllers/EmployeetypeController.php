	 ...
	 if ($model != null)
      {
		...
		echo CJSON::encode(array(
			...
			'snroid'=>$model->snroid,
			'snroname'=>($model->snro!==null)?$model->snro->description:"",
			'sicksnroid'=>$model->sicksnroid,
			'sicksnroname'=>($model->sicksnro!==null)?$model->sicksnro->description:"",
			'sickstatusid'=>$model->sickstatusid,
			'sickstatusname'=>($model->sickstatus!==null)?$model->sickstatus->shortstat:"",
	...
	public function actionWrite()
	{
	  ...
	  if(isset($_POST['Employeetype']))
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Employeetype']['employeetypename'],'hrmetemptyemployeetypename','emptystring'),
            )
        );
        if ($messages == '') {
