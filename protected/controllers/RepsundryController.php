...
class RepsundryController extends Controller
{
	/**
	...
	public function actionIndex()
	{
      ...
      {
        $this->pdf->title='Sundry Debtor Report';
	  $this->pdf->AddPage('L');
...
";
      ...
      $this->pdf->setwidths(array(10,20,25,25,25,25,25,25,30,30,30,30));
      ...
      $this->pdf->coldetailalign = array('L','L','L','L','L','L','L','L','L','L','R','R');
