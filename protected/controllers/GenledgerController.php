...
$this->pdf->sety($this->pdf->gety()+5);
        ...
        $sql1 = "select c.accountcode,c.accountname, a.debit,a.credit,a.postdate,d.symbol,b.referenceno,b.journalnote
from genledger a
...
where e.accounttypename = 'Detail' and a.postdate between '".$_POST['startperiod']."' and '".$_POST['endperiod']."' and a.accountid = ".$row['accountid']." order by a.postdate";
		...
		$this->pdf->setY($this->pdf->GetY() + 15);
          ...
          $this->pdf->setwidths(array(40,20,30,30,50));
      $this->pdf->colalign = array('C','C','C','C','C');
	  $this->pdf->colheader = array('Reference No','Post Date','Debit','Credit','Description');
          $this->pdf->rowheader();
      ...
      $this->pdf->coldetailalign = array('L','L','R','R','L');
