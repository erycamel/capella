	...
	public function actionWrite()
	{
	  ...
	  if(isset($_POST['Plant']))
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Plant']['plantcode'],'cplemptyplantcode','emptystring'),
                array($_POST['Plant']['description'],'cplemptydescription','emptystring'),
            )
        );
        if ($messages == '') {
...
public function actionDownload()
  {
    ...
    // menuliskan tabel
    $header = array('No','ID','Plant Code','Description');
    $model=new Plant('searchwstatus');
    ...
    foreach($data as $datas)
    {
        ...
        $pdf->Cell($w[1],6,$datas['plantid'],'LR',0,'L',$fill);
        $pdf->Cell($w[2],6,$datas['plantcode'],'LR',0,'L',$fill);
