	...
	public function actionWrite()
	{
	  ...
	  if(isset($_POST['Materialtype']))
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Materialtype']['materialtypecode'],'pmmtemptymaterialtypecode','emptystring'),
                array($_POST['Materialtype']['description'],'pmmtemptydescription','emptystring'),
            )
        );
        if ($messages == '') {
