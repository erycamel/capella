...
$this->lookupdata();
	...
	public function actionWrite()
	{
	  ...
	  if(isset($_POST['Customer']))
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Customer']['fullname'],'scuemptyfullname','emptystring'),
            )
        );
        if ($messages == '') {
	...
	public function actionWriteaddress()
	{
	  ...
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Customeraddress']['addresstypeid'],'scuemptyaddresstypeid','emptystring'),
                array($_POST['Customeraddress']['addressname'],'scuemptyaddressname','emptystring'),
                array($_POST['Customeraddress']['cityid'],'scuemptycityid','emptystring'),
            )
        );
        if ($messages == '') {
	...
	public function actionWritecontact()
	{
	  ...
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Customercontact']['contacttypeid'],'scuemptycontacttypeid','emptystring'),
                array($_POST['Customercontact']['addresscontactname'],'scuemptyaddresscontactname','emptystring'),
            )
        );
        if ($messages == '') {
