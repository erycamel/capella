...
class ReprealpayController extends Controller
{
	...
	public function actionIndex()
	{
      ...
      {
        $this->pdf->title='Payment Realization';
	  $this->pdf->AddPage('L');
...
where a.invoicetypeid = 1 and a.invoiceid in (select invoiceid from cashbank where cashbankid = 1)
) z1
