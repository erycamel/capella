	...
	public function actionWrite()
	{
	  ...
	  if(isset($_POST['Purchasingorg']))
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Purchasingorg']['purchasingorgcode'],'ppoemptypurchasingorgcode','emptystring'),
                array($_POST['Purchasingorg']['description'],'ppoemptydescription','emptystring'),
            )
        );
        if ($messages == '') {
