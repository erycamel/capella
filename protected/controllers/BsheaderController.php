...
if ($bsdetail != null)
    ...
    {
      $model = Bsheader::model()->findbypk($_POST['Bsheader']['bsheaderid']);
      if ($model != null)
      {
        $model->Delete();
      }
      $this->DeleteLockCloseForm($this->menuname, $_POST['Bsheader'], $_POST['Bsheader']['bsheaderid']);
    }
	...
	public function actionWrite()
	{
	  if(isset($_POST['Bsheader']))
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Bsheader']['bsdate'],'ibsdateemptybsdate','emptystring'),
            )
        );
        if ($messages == '') {
		...
		try
          {
            if($model->save())
            {
              ...
              $this->GetSMessage('ibsinsertsuccess');
            }
            else
            {
	...
	public function actionWritedetail()
	{
	  ...
	  {
	  $messages = $this->ValidateData(
                array(array($_POST['Bsdetail']['productid'],'ibsdateemptyproductid','emptystring'),
				array($_POST['Bsdetail']['quantity'],'ibsdateemptyquantity','emptystring'),
				array($_POST['Bsdetail']['slocid'],'ibsdateemptyslocid','emptystring'),
				array($_POST['Bsdetail']['unitofmeasureid'],'ibsdateemptyunitofmeasureid','emptystring'),
            )
        );
        if ($messages == '') {
