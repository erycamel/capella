...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=purchasingorg/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=purchasingorg/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript" >
	$(function(){
...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1>Parameter: Purchasing Organizations</h1>
<div id="toolbar">
<ul>
<?php
