...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=workflow/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=workflow/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1>Parameter: Work Flow</h1><div id="toolbar">
<ul>
<?php
