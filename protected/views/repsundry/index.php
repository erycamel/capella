...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=repsundry/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function showdetail() {
    $.fn.yiiGridView.update('datagrid', {
                    data: {
                        'repsundry[accountid]': $('#accountid').val()
                    }
                });
    return false;
}
...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1>Report: Sundry Debtor Transaction</h1>
<div id="toolbar">
<?php
...
<form action="index.php?r=repsundry/index" method="POST">
