...
function adddata() {
    jQuery.ajax({
        'url': '/smlive/index.php?r=product/create',
        'data': $(this).serialize(),
        'type': 'post',
        'dataType': 'json',
...
function editdata() {
    jQuery.ajax({
        'url': '/smlive/index.php?r=product/update',
        'data': {
...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=product/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=product/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript" >
	$(function(){
		...
		new AjaxUpload(btnUpload, {
			action: 'index.php?r=product/upload',
			name: 'uploadfile',
...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1>Parameter: Material - Main Data</h1>
<div id="toolbar">
<ul>
<?php
