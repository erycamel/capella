...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=province/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=province/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
  ...
  'selectableRows'=>1,
	...
	array('name'=>'provinceid','visible'=>false, 'header'=>'ID','value'=>'$data->provinceid','htmlOptions'=>array('width'=>'1%')),
		array('name'=>'countryid', 'header'=>'Country Name','value'=>'($data->country!==null)?$data->country->countryname:""'),
		'provincename',
    array(
      'class'=>'CCheckBoxColumn',
      'name'=>'recordstatus',
