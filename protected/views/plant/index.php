...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=plant/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
echo CHtml::link($imgdown,array('/plant/download'),array(
   'style'=>'cursor: pointer; text-decoration: underline;',
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	array('name'=>'plantcode', 'header'=>'Plant Code','value'=>'$data->plantcode','htmlOptions'=>array('width'=>'1%')),
	'description',
    array(
      'class'=>'CCheckBoxColumn',
      'name'=>'recordstatus',
