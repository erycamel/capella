...
<?php echo $form->hiddenField($model,'employeeid'); ?>
                  ...
                  $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns'=>array(
                      ...
                      /* Here is The Button that will send the Data to The MAIN FORM */
                        ...
                        "id" => "send_employee",
                        "onClick" => "$(\"#employee_dialog\").dialog(\"close\"); $(\"#employee_name\").val(\"$data->fullname\"); $(\"#Applicantinformal_employeeid\").val(\"$data->employeeid\");"))',
                        ),
                      'employeeid',
                      'fullname',
                      ),
	...
	<table>
	  ...
	  'success'=>'function(data)
		...
		array('applicantinformal/cancelwrite'),
	  array(
	  'success'=>'function(data)
		{
			var x = eval("(" + data + ")");
