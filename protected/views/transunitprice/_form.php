    ...
    $this->widget('zii.widgets.grid.CGridView', array(
      ...
      'columns'=>array(
        ...
        /* Here is The Button that will send the Data to The MAIN FORM */
          ...
          "id" => "send_absschedule",
          "onClick" => "$(\"#pricetype_dialog\").dialog(\"close\"); $(\"#pricetypename\").val(\"$data->pricetypename\"); $(\"#Transunitprice_pricetypeid\").val(\"$data->pricetypeid\");
		  "))',
          ),
        'pricetypeid',
        'pricetypename',
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
      ...
      'columns'=>array(
        ...
        /* Here is The Button that will send the Data to The MAIN FORM */
          ...
          array("name" => "send_absschedule",
          "id" => "send_absschedule",
          "onClick" => "$(\"#currency_dialog\").dialog(\"close\"); $(\"#currencyname\").val(\"$data->currencyname\"); $(\"#Transunitprice_currencyid\").val(\"$data->currencyid\");
		  "))',
          ),
        'currencyid',
        'country.countryname',
