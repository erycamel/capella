...
<?php echo $form->hiddenField($model,'employeeid'); ?>
                  ...
                  $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns'=>array(
                      ...
                      /* Here is The Button that will send the Data to The MAIN FORM */
                        ...
                        "id" => "send_employee",
                        "onClick" => "$(\"#employee_dialog\").dialog(\"close\"); $(\"#employee_name\").val(\"$data->fullname\"); $(\"#Applicantjamsostek_employeeid\").val(\"$data->employeeid\");"))',
                        ),
                      'employeeid',
                      'fullname',
                      ),
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'jamsostekdate');?> format yyyy-mm-dd
	...
	<table>
      <tr>
		...
		array('applicantjamsostek/write'),
	  array(
	  'success'=>'function(data)
		...
		array('applicantjamsostek/cancelwrite'),
	  array(
	  'success'=>'function(data)
		{
			var x = eval("(" + data + ")");
