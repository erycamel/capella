...
function adddata() {
    jQuery.ajax({
        'url': '/smlive/index.php?r=cashbankin/create',
        'data': $(this).serialize(),
        'type': 'post',
        'dataType': 'json',
...
function editdata() {
    jQuery.ajax({
        'url': '/smlive/index.php?r=cashbankin/update',
        'data': {
...
<script type="text/javascript">
function deletedata()
{jQuery.ajax({'url':'/smlive/index.php?r=cashbankin/delete','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
{},'cache':false});;$.fn.yiiGridView.update('datagrid');return false;}
</script>
<script type="text/javascript">
function approvedata()
{jQuery.ajax({'url':'/smlive/index.php?r=cashbankin/approve','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json',
'success':function(data)
{
...
function helpdata(value) {
    jQuery.ajax({
        'url': '/smlive/index.php?r=cashbankin/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=cashbankin/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function showdetail() {
...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1>Transaction: Cash / Bank Receipt</h1>
<div id="toolbar">
<ul>
<?php
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'description',
		array('header'=>'Status','value'=>'Wfstatus::model()->findstatusname("appcbin",$data->recordstatus)')
  ),
));
?>
<?php
