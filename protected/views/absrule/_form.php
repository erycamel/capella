...
<?php echo $form->hiddenField($model,'absruleid'); ?>
    ...
    <?php echo $form->hiddenField($model,'absscheduleid'); ?>
	  <input type="text" name="sched_name" id="sched_name" title="Enter Schedule name" readonly value="<?php echo (Absschedule::model()->findByPk($model->absscheduleid)!==null)?Absschedule::model()->findByPk($model->absscheduleid)->absschedulename:''; ?>">
    <?php
