...
function adddata()
{jQuery.ajax({'url':'/smlive/index.php?r=wfgroup/create','data':$(this).serialize(),'type':'post','dataType':'json','success':function(data)
...
<script type="text/javascript">
function editdata()
{jQuery.ajax({'url':'/smlive/index.php?r=wfgroup/update','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
{document.getElementById('messages').innerHTML='';if(data.status=='success')
...
<script type="text/javascript">
function deletedata()
{jQuery.ajax({'url':'/smlive/index.php?r=wfgroup/delete','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=wfgroup/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=wfgroup/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
...
<?php $this->endWidget();?>
<h1>Transaction: Workflow Group Assignment</h1>
<div id="toolbar">
<ul>
<?php
...
$this->widget('zii.widgets.grid.CGridView', array(
  ...
  'selectableRows'=>1,
	...
	array('name'=>'wfgroupid', 'visible'=>false, 'value'=>'$data->wfgroupid','htmlOptions'=>array('width'=>'1%')),
		array('name'=>'workflowid', 'value'=>'($data->workflow!==null)?$data->workflow->wfdesc:""'),
