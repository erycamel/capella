...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=snro/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=snro/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1>Parameter: Specific Number Range Object</h1>
<div id="toolbar">
<ul>
<?php
