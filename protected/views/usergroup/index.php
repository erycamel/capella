...
function adddata()
{jQuery.ajax({'url':'/smlive/index.php?r=usergroup/create','data':$(this).serialize(),'type':'post','dataType':'json','success':function(data)
...
<script type="text/javascript">
function editdata()
{jQuery.ajax({'url':'/smlive/index.php?r=usergroup/update','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
{document.getElementById('messages').innerHTML = '';if(data.status=='success')
...
<script type="text/javascript">
function deletedata()
{jQuery.ajax({'url':'/smlive/index.php?r=usergroup/delete','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=usergroup/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=usergroup/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1>User Group Assignment</h1><div id="toolbar">
<ul>
<?php
