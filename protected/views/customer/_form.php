...
<?php echo $form->hiddenField($model,'acchutangid'); ?>
          <input type="text" name="addresstype_name" id="acchutangname" readonly value="<?php
echo (Account::model()->findByPk($model->acchutangid)!==null)?Account::model()->findByPk($model->acchutangid)->accountname:'';?>">
          <?php
