                  ...
                  $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns'=>array(
                      ...
                      /* Here is The Button that will send the Data to The MAIN FORM */
                        ...
                        "id" => "send_employee",
                        "onClick" => "$(\"#employee_dialog\").dialog(\"close\"); $(\"#employee_name\").val(\"$data->fullname\"); $(\"#Applicantidentity_employeeid\").val(\"$data->employeeid\");"))',
                        ),
                      'employeeid',
                      'fullname',
                      ),
...
<?php echo $form->hiddenField($model,'identitytypeid'); ?>
                  ...
                  $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns'=>array(
                      ...
                      /* Here is The Button that will send the Data to The MAIN FORM */
                        ...
                        "onClick" => "$(\"#identitytype_dialog\").dialog(\"close\"); $(\"#identitytype_name\").val(\"$data->identitytypename\"); $(\"#Applicantidentity_identitytypeid\").val(\"$data->identitytypeid\");"))',
                        ),
                      'identitytypeid',
                      'identitytypename',
                      ),
	...
	<table>
	  ...
	  'success'=>'function(data)
		...
		array('applicantidentity/cancelwrite'),
	  array(
	  'success'=>'function(data)
		{
			var x = eval("(" + data + ")");
