...
<?php echo $form->hiddenField($model,'pocdetailid'); ?>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
      ...
      'columns'=>array(
        ...
        /* Here is The Button that will send the Data to The MAIN FORM */
          ...
          "id" => "send_absschedule",
          "onClick" => "$(\"#product_dialog\").dialog(\"close\"); $(\"#productname\").val(\"$data->productname\"); $(\"#Pocdetail_productid\").val(\"$data->productid\");
		  "))',
          ),
        'productid',
        'productname',
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
      ...
      'columns'=>array(
        ...
        /* Here is The Button that will send the Data to The MAIN FORM */
          ...
          array("name" => "send_absschedule",
          "id" => "send_absschedule",
          "onClick" => "$(\"#uom_dialog\").dialog(\"close\"); $(\"#uomcode\").val(\"$data->uomcode\"); $(\"#Pocdetail_unitofmeasureid\").val(\"$data->unitofmeasureid\");
		  "))',
          ),
        'unitofmeasureid',
        'uomcode',
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
      ...
      'columns'=>array(
        ...
        /* Here is The Button that will send the Data to The MAIN FORM */
          ...
          array("name" => "send_absschedule",
          "id" => "send_absschedule",
          "onClick" => "$(\"#serviceuom_dialog\").dialog(\"close\"); $(\"#serviceuomcode\").val(\"$data->uomcode\"); $(\"#Pocdetail_serviceuomid\").val(\"$data->unitofmeasureid\");
		  "))',
          ),
        'unitofmeasureid',
        'uomcode',
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
      ...
      'columns'=>array(
        ...
        /* Here is The Button that will send the Data to The MAIN FORM */
          ...
          array("name" => "send_absschedule",
          "id" => "send_absschedule",
          "onClick" => "$(\"#servicecurrency_dialog\").dialog(\"close\"); $(\"#servicecurrencyname\").val(\"$data->currencyname\");
          $(\"#Pocdetail_servicecurrencyid\").val(\"$data->currencyid\");
		  "))',
          ),
        'currencyid',
        'currencyname',
