...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=snrodet/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=snrodet/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1>Specific Number Range Object Details</h1>
<div id="toolbar">
<ul>
<?php
