...
function helpdata(value) {
    jQuery.ajax({
        'url': '/smlive/index.php?r=repinvap/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=repinvap/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function showdetail() {
...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1>Report: Invoice from Supplier</h1>
<div id="toolbar">
<ul>
<?php
