...
function adddata()
{jQuery.ajax({'url':'/smlive/index.php?r=bank/create','data':$(this).serialize(),'type':'post','dataType':'json','success':function(data)
...
<script type="text/javascript">
function editdata()
{jQuery.ajax({'url':'/smlive/index.php?r=bank/update','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
{document.getElementById('messages').innerHTML='';if(data.status=='success')
...
<script type="text/javascript">
function deletedata()
{jQuery.ajax({'url':'/smlive/index.php?r=bank/delete','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
...
function helpdata(value) {
    jQuery.ajax({
        'url': '/smlive/index.php?r=bank/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1>Bank</h1><div id="toolbardoublegrid">
<?php
...
echo CHtml::link($imgdown,array('/bank/download'),array(
   'style'=>'cursor: pointer; text-decoration: underline;',
