...
function adddata1()
{
    <?php echo CHtml::ajax(array(
			'url'=>array('employeeover/createdetail'),
            ...
            'success'=>"function(data)
            {
                ...
                if (data.status == 'success')
                {
					...
					$('#Employeeoverdet_employeeoverdetid').val('');
					$('#Employeeoverdet_employeeid').val('');
					$('#fullname').val('');
					$('#Employeeoverdet_overtime').val('');
					$('#Employeeoverdet_overtimeend').val('');
...
function editdata1()
{
	...
	echo CHtml::ajax(array(
			'url'=>array('employeeover/updatedetail'),
...
document.getElementById('messages').innerHTML = '';
                ...
                {
                    $('#createdialog1 div.divcreate1').html(data.div);
					$('#Employeeoverdet_employeeoverdetid').val(data.employeeoverdetid);
					$('#Employeeoverdet_employeeid').val(data.employeeid);
					$('#fullname').val(data.fullname);
					$('#Employeeoverdet_overtime').val(data.overtime);
					$('#Employeeoverdet_overtimeend').val(data.overtimeend);
                          // Here is the trick: on submit-> once again this function!
                    $('#createdialog1').dialog('open');
                }
                else
...
function deletedata1()
{
    <?php
	echo CHtml::ajax(array(
			'url'=>array('employeeover/deletedetail'),
            'data'=> array('id'=>'js:$.fn.yiiGridView.getSelection("detaildatagrid")'),
            'type'=>'post',
            'dataType'=>'json',
            'success'=>"function(data)
...
<?php echo $this->renderPartial('_formdetail', array('model'=>$employeeoverdet)); ?>
<?php $this->endWidget();?>
<?php
