...
<?php echo $form->hiddenField($model,'addresstypeid'); ?>
          <input type="text" name="addresstype_name" id="addresstype_name" readonly value="<?php echo Addresstype::model()->findByPk($model->addresstypeid)->addresstypename ?>">
          <?php
...
$addresstype = new Addresstype('searchwstatus');
          ...
          $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
              ...
              /* Here is The Button that will send the Data to The MAIN FORM */
                ...
                "id" => "send_addresstype",
                "onClick" => "$(\"#addresstype_dialog\").dialog(\"close\"); $(\"#addresstype_name\").val(\"$data->addresstypename\"); $(\"#Cateringaddress_addresstypeid\").val(\"$data->addresstypeid\");"))',
                ),
              'addresstypeid',
              'addresstypename',
              array(
    ...
    <?php echo $form->hiddenField($model,'cityid'); ?>
          <input type="text" name="city_name" id="city_name" readonly value="<?php echo City::model()->findByPk($model->cityid)->cityname ?>">
          <?php
            $this->beginWidget('zii.widgets.jui.CJuiDialog',
          ...
          $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
              ...
              /* Here is The Button that will send the Data to The MAIN FORM */
                ...
                "id" => "send_city",
                "onClick" => "$(\"#city_dialog\").dialog(\"close\"); $(\"#city_name\").val(\"$data->cityname\"); $(\"#Cateringaddress_cityid\").val(\"$data->cityid\");"))',
                ),
              'cityid',
              'cityname',
              array(
...
<?php echo $form->hiddenField($model,'kelurahanid'); ?>
          <input type="text" name="kelurahan_name" id="kelurahan_name" readonly value="<?php echo Kelurahan::model()->findByPk($model->kelurahanid)->kelurahanname ?>">
          <?php
            $this->beginWidget('zii.widgets.jui.CJuiDialog',
          ...
          $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
              ...
              /* Here is The Button that will send the Data to The MAIN FORM */
                ...
                "id" => "send_kelurahan",
                "onClick" => "$(\"#kelurahan_dialog\").dialog(\"close\"); $(\"#kelurahan_name\").val(\"$data->kelurahanname\"); $(\"#Cateringaddress_kelurahanid\").val(\"$data->kelurahanid\");"))',
                ),
              'kelurahanid',
              'kelurahanname',
              array(
...
<?php echo $form->hiddenField($model,'subdistrictid'); ?>
          <input type="text" name="subdistrict_name" id="subdistrict_name" readonly value="<?php echo Subdistrict::model()->findByPk($model->subdistrictid)->subdistrictname ?>">
          <?php
            $this->beginWidget('zii.widgets.jui.CJuiDialog',
          ...
          $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
              ...
              /* Here is The Button that will send the Data to The MAIN FORM */
                ...
                "id" => "send_subdistrict",
                "onClick" => "$(\"#subdistrict_dialog\").dialog(\"close\"); $(\"#subdistrict_name\").val(\"$data->subdistrictname\"); $(\"#Cateringaddress_subdistrictid\").val(\"$data->subdistrictid\");"))',
                ),
              'subdistrictid',
              'subdistrictname',
              array(
