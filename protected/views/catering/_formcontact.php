...
<?php echo $form->hiddenField($model,'contacttypeid'); ?>
          <input type="text" name="contacttype_name" id="contacttype_name" readonly value="<?php echo Contacttype::model()->findByPk($model->contacttypeid)->contacttypename ?>">
          <?php
          ...
          $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
              ...
              /* Here is The Button that will send the Data to The MAIN FORM */
                ...
                "id" => "send_contacttype",
                "onClick" => "$(\"#contacttype_dialog\").dialog(\"close\"); $(\"#contacttype_name\").val(\"$data->contacttypename\"); $(\"#Cateringcontact_contacttypeid\").val(\"$data->contacttypeid\");"))',
                ),
              'contacttypeid',
              'contacttypename',
              array(
