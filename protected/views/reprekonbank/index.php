...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=reprekonbank/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function showdetail() {
    $.fn.yiiGridView.update('datagrid', {
                    data: {
                        'reprekonbank[accountid]': $('#accountid').val()
                    }
                });
    return false;
}
...
<form action="index.php?r=reprekonbank/index" method="POST">
