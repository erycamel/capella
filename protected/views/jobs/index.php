...
function adddata()
{jQuery.ajax({'url':'/smlive/index.php?r=jobs/create','data':$(this).serialize(),'type':'post','dataType':'json','success':function(data)
...
<script type="text/javascript">
function editdata()
{jQuery.ajax({'url':'/smlive/index.php?r=jobs/update','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
{document.getElementById('messages').innerHTML='';if(data.status=='success')
...
<script type="text/javascript">
function deletedata()
{jQuery.ajax({'url':'/smlive/index.php?r=jobs/delete','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=jobs/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=jobs/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
