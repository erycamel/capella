                  ...
                  $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns'=>array(
                      ...
                      /* Here is The Button that will send the Data to The MAIN FORM */
                        ...
                        "id" => "send_employee",
                        "onClick" => "$(\"#employee_dialog\").dialog(\"close\"); $(\"#employee_name\").val(\"$data->fullname\"); $(\"#Employeefamily_employeeid\").val(\"$data->employeeid\");"))',
                        ),
                  ...
                  $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns'=>array(
                      ...
                      /* Here is The Button that will send the Data to The MAIN FORM */
                        ...
                        array("name" => "send_sex",
                        "id" => "send_sex",
                        "onClick" => "$(\"#sex_dialog\").dialog(\"close\"); $(\"#sex_name\").val(\"$data->sexname\"); $(\"#Employeefamily_sexid\").val(\"$data->sexid\");"))',
                        ),
                  ...
                  $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns'=>array(
                      ...
                      /* Here is The Button that will send the Data to The MAIN FORM */
                        ...
                        "id" => "send_city",
                        "onClick" => "$(\"#city_dialog\").dialog(\"close\"); $(\"#city_name\").val(\"$data->cityname\"); $(\"#Employeefamily_cityid\").val(\"$data->cityid\");"))',
                        ),
                  ...
                  $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns'=>array(
                      ...
                      /* Here is The Button that will send the Data to The MAIN FORM */
                        ...
                        "id" => "send_education",
                        "onClick" => "$(\"#education_dialog\").dialog(\"close\"); $(\"#education_name\").val(\"$data->educationname\"); $(\"#Employeefamily_educationid\").val(\"$data->educationid\");"))',
                        ),
...
<?php echo $form->hiddenField($model,'occupationid'); ?>
	...
	<table>
	  ...
	  'success'=>'function(data)
		...
		array('employeefamily/cancelwrite'),
	  array(
	  'success'=>'function(data)
		{
			var x = eval("(" + data + ")");
