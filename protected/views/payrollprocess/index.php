...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1>Transaction: Payroll Process</h1>
<div id="toolbar">
<?php
...
<div id="formabs">
<form action="index.php?r=payrollprocess/index" method="POST">
	  ...
	  'success'=>'function(data)
		{
			...
			if (x.status == "success")
			{
              document.getElementById("messages").innerHTML = "proses gaji sukses, silakan cetak menggunakan menu employeewage";
			}
        }')); ?>
</form></div>
