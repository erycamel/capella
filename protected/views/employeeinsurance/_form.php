                  ...
                  $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns'=>array(
                      ...
                      /* Here is The Button that will send the Data to The MAIN FORM */
                        ...
                        "id" => "send_employee",
                        "onClick" => "$(\"#employee_dialog\").dialog(\"close\"); $(\"#employee_name\").val(\"$data->fullname\"); $(\"#Employeeinsurance_employeeid\").val(\"$data->employeeid\");"))',
                        ),
...
<?php echo $form->hiddenField($model,'insuranceid'); ?>
                    ...
                    $this->widget('zii.widgets.grid.CGridView', array(
                      ...
                      'columns'=>array(
                        ...
                        /* Here is The Button that will send the Data to The MAIN FORM */
                          ...
                          "id" => "send_insurance",
                          "onClick" => "$(\"#insurance_dialog\").dialog(\"close\"); $(\"#insurance_name\").val(\"$data->fullname\"); $(\"#Employeeinsurance_insuranceid\").val(\"$data->addressbookid\");"))',
                          ),
	...
	<table>
	  ...
	  'success'=>'function(data)
		...
		array('employeeinsurance/cancelwrite'),
	  array(
	  'success'=>'function(data)
		{
			var x = eval("(" + data + ")");
