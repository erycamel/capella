...
function adddata() {
    jQuery.ajax({
        'url': '/smlive/index.php?r=groupaccess/create',
        'data': $(this).serialize(),
        'type': 'post',
        'dataType': 'json',
...
function editdata() {
    jQuery.ajax({
        'url': '/smlive/index.php?r=groupaccess/update',
        'data': {
...
<script type="text/javascript">
function deletedata()
{jQuery.ajax({'url':'/smlive/index.php?r=groupaccess/delete','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
...
function helpdata(value) {
	jQuery.ajax({
        'url': '/smlive/index.php?r=groupaccess/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/smlive/index.php?r=groupaccess/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
