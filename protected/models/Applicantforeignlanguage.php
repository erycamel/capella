 ...
 */
class Applicantforeignlanguage extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Applicantforeignlanguage the static model class
	 */
	...
	public function search()
	{
		...
		$criteria->with=array('applicant.addressbook','language','languagevalue');
  ...
  /**
    ...
    $criteria->with=array('applicant','language','languagevalue');
		$criteria->compare('employeeforeignlanguageid',$this->employeeforeignlanguageid);
