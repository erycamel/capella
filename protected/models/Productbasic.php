...
class Productbasic extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('productid, baseuom, materialgroupid, divisionid, weightunit, volumeunit, materialpackage, recordstatus', 'numerical', 'integerOnly'=>true),
			...
			array('productbasicid, productid, baseuom, materialgroupid, oldmatno, divisionid, grossweight, weightunit, netweight, volume, volumeunit, sizedimension, materialpackage', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
        ...
        $criteria->with=array('product','materialgroup','materialpackage0',
            'division','baseuom0','baseuom1','baseuom1','baseuom2');
		...
		$criteria->compare('division.divisioncode',$this->divisionid,true);
