 ...
 */
class ApplicantAddressbook extends CActiveRecord
{
	/**
...
$criteria->condition='t.isemployee=0 and t.isapplicant=1';
...
'criteria'=>$criteria,
	...
	public function searchwstatus()
	{
		...
		$criteria=new CDbCriteria;
		$criteria->condition='recordstatus=1 and t.isapplicant=1 and t.isemployee=0';
		$criteria->compare('addressbookid',$this->addressbookid);
		$criteria->compare('fullname',$this->fullname,true);
		$criteria->compare('iscustomer',$this->iscustomer);
		$criteria->compare('isemployee',$this->isemployee);
