 ...
 */
class Applicantidentity extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Applicantidentity the static model class
	 */
	...
	public function search()
	{
		...
		$criteria->with=array('applicant.addressbook','identitytype');
  ...
  /**
	...
	public function searchwstatus()
	{
		...
		$criteria=new CDbCriteria;
    $criteria->with=array('applicant','identitytype');
