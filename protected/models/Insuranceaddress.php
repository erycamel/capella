 ...
 * @property InsuranceAddressbook $addressbook
 * @property City $city
 * @property Subdistrict $subdistrict
 * @property InsuranceAddresstype $addresstype
 */
class Insuranceaddress extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Insuranceaddress the static model class
	 */
...
$model=new Insuranceaddress('search');
$model->attributes = $_GET['Insuranceaddress'];
$criteria->condition='addressbook.isinsurance=1 and t.addressbookid='.$model->addressbookid;
} else {
$criteria->condition='addressbook.isinsurance=1 and t.addressbookid=0';
}
