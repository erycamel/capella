...
class Employeefamily extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('familyname,birthdate', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('employeefamilyid, employeeid, familyrelationid, familyname, sexid, cityid, birthdate, educationid, 
occupationid, recordstatus', 'safe', 'on'=>'search'),
		);
	}
  ...
  public function beforeSave()
    ...
    $criteria->with=array('employee','familyrelation','sex','city','education',
      'occupation');	$criteria->compare('employeefamilyid',$this->employeefamilyid);
