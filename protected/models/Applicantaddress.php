 ...
 * @property ApplicantAddressbook $addressbook
 * @property City $city
 * @property Subdistrict $subdistrict
 * @property ApplicantAddresstype $addresstype
 */
class Applicantaddress extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Applicantaddress the static model class
	 */
