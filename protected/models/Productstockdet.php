...
class Productstockdet extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('productid, qty, unitofmeasureid, slocid, transtypeid, 
			prodtranstypeid,referenceno,productstockid', 'length'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'unitofmeasureid' => 'UOM',
			'slocid' => 'Sloc',
			'transtypeid' => 'Trans Type',
			'prodtranstypeid' => 'Prod Transtype',
