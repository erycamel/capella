 ...
 */
class MyWorkorder extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('productid, workorderstaffid, eventrequestid, recordstatus', 'numerical', 'integerOnly'=>true),
	...
	public function search()
	{
		...
		$criteria->with=array('product','workorderstaff','eventrequest','workorderstaff');
		$useraccess = Useraccess::model()->findbyattributes(array('username'=>Yii::app()->user->id));
		$criteria->condition="workorderstaff.useraccessid=".$useraccess->useraccessid;
