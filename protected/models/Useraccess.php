...
class Useraccess extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('recordstatus,employeeid,languageid', 'numerical', 'integerOnly'=>true),
			array('username', 'length', 'max'=>50),
			array('realname, email', 'length', 'max'=>100),
			array('password, salt', 'length', 'max'=>128),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('useraccessid, username, realname, password, salt, languageid,email, recordstatus,employeeid', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'abstrans' => array(self::HAS_MANY, 'Abstrans', 'machineid'),
...
$criteria->with=array('employee','language');
