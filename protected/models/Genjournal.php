...
class Genjournal extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('referenceno,journalno', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('genjournalid, referenceno, journaldate, journalnote, postdate,recordstatus', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('journalno',$this->journalno,true);
...
'pagination'=>array(
    ...
    public function beforeSave() {
        $this->journaldate = ($this->journaldate!==null)?($this->journaldate!=="")?date(Yii::app()->params['datetodb'], strtotime($this->journaldate)):null:null;
        $this->postdate = ($this->postdate!==null)?($this->postdate!=="")?date(Yii::app()->params['datetodb'], strtotime($this->postdate)):null:null;
