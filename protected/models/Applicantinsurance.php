 ...
 */
class Applicantinsurance extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Applicantinsurance the static model class
	 */
	...
	public function search()
	{
		...
		$criteria->with=array('applicant.addressbook','insurance');
  ...
  /**
	...
	public function searchwstatus()
	{
		...
		$criteria=new CDbCriteria;
		$criteria->with=array('applicant','insurance');
