...
class Insurance extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('iscustomer, isemployee, isapplicant, isvendor, isinsurance, isbank, isinsurance, recordstatus,accpiutangid', 'numerical', 'integerOnly'=>true),
			array('fullname', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('addressbookid, fullname, iscustomer, isemployee, isapplicant, isvendor, isinsurance, isbank, isinsurance, recordstatus,accpiutangid', 'safe', 'on'=>'search'),
		);
	}
    ...
    $criteria->condition='isinsurance=1';
...
'pagination'=>array(
  ...
  /**
	...
	public function searchwstatus()
	{
		...
		$criteria=new CDbCriteria;
        $criteria->with=array('accpiutang');
    $criteria->condition='isinsurance=1 and t.recordstatus=1';
		$criteria->compare('addressbookid',$this->addressbookid);
		$criteria->compare('fullname',$this->fullname,true);
		$criteria->compare('iscustomer',$this->iscustomer);
		$criteria->compare('isemployee',$this->isemployee);
