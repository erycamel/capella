...
class Division extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('divisioncode, description, recordstatus', 'required'),
			array('recordstatus', 'numerical', 'integerOnly'=>true),
			array('divisioncode', 'length', 'max'=>5),
			array('description', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('divisionid, divisioncode, description, recordstatus', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('divisioncode',$this->divisioncode,true);
