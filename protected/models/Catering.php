 ...
 * @property Cateringaccount[] $cateringaccounts
...
class Catering extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('iscustomer, isemployee, isapplicant, isvendor, isinsurance, iscatering, ishospital, recordstatus', 'numerical', 'integerOnly'=>true),
			array('fullname', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('addressbookid, fullname, iscustomer, isemployee, isapplicant, isvendor, ishospital, iscatering, isinsurance, recordstatus', 'safe', 'on'=>'search'),
		);
	}
    ...
    $criteria->condition='iscatering=1';
		...
		$criteria->compare('iscatering',$this->iscatering);
...
'pagination'=>array(
  ...
  /**
	...
	public function searchwstatus()
	{
		...
		$criteria=new CDbCriteria;
    $criteria->condition='iscatering=1 and recordstatus=1';
		$criteria->compare('addressbookid',$this->addressbookid);
		$criteria->compare('fullname',$this->fullname,true);
		$criteria->compare('iscustomer',$this->iscustomer);
		$criteria->compare('isemployee',$this->isemployee);
