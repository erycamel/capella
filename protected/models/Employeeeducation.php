...
class Employeeeducation extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('schoolname,schooldegree', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('employeeeducationid, employeeid, educationid, schoolname, cityid, yeargraduate, isdiploma, 
recordstatus,schooldegree', 'safe', 'on'=>'search'),
		);
	}
    ...
    $criteria->with=array('employee','city','education');
		...
		$criteria->compare('schooldegree',$this->schooldegree,true);
