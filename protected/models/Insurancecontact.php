 ...
 */
class Insurancecontact extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'addressbook' => array(self::BELONGS_TO, 'Insurance', 'addressbookid'),
...
$model=new Insurancecontact('search');
$model->attributes = $_GET['Insurancecontact'];
