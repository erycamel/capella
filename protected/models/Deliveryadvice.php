...
class Deliveryadvice extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('recordstatus,useraccessid,projectid,slocid', 'numerical', 'integerOnly'=>true),
array('dadate','length'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('deliveryadviceid, dano, headernote, recordstatus,slocid,useraccessid,projectid,dadate', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
            ...
            'projectid'=>'Service Request Form',
	...
	public function search()
	{
        ...
        $criteria->with=array('project','useraccess','sloc');
